 ...
 *         24-Oct-2013, revised 25-Oct-2014
 *         <p/>
...
public class ParkingDriver {
    ...
    {
        //$System.out.println("---entered testSmallLot---");
    ...
    {
        //$System.out.println("---entered testTinyDistrict---");
        District ourTown = new District("red", 1, "green", 1, "blue", 2);
        System.out.println("Tiny district:");
        ourTown.markVehicleEntry(2, 5);//closed at 5 min
        ourTown.markVehicleEntry(1, 7);// closed at 7 min
        ourTown.markVehicleEntry(3, 10);
        ourTown.markVehicleEntry(3, 12);//closed at 12 min
        if (!ourTown.isClosed())
            System.out.println(">>> Error in tiny district at 12: should be closed.");
        ourTown.markVehicleExit(2, 15);//15-5=10
        if (ourTown.isClosed())
            System.out.println(">>> Error in tiny district at 15: should be open.");
        ourTown.displayStatus();
        ourTown.markVehicleExit(1, 17);//17-7 =10
        ourTown.markVehicleEntry(2, 18);//closed at 18
        if (ourTown.isClosed())
    ...
    {
        //$System.out.println("---entered testComingAndGoing---");
        ...
        busy.markVehicleEntry(35); // lot closes
        if ( !busy.isClosed() )
        ...
        busy.markVehicleExit(50); // lot reopens / closed time is 50(line 122)-35(line 111)=15
        busy.markVehicleExit(54);
        busy.markVehicleExit(60);
        busy.markVehicleExit(60);// is this lot exit value used in the closed number?
        if ( busy.closedMinutes() != 25 ) // closed time is 15 minutes, execute the statement, cannot be 25 as 50-35=15
    ...
    {
        //$System.out.println("---entered testOverFillingLot---");
    ...
    {
        //$System.out.println("---entered testParkingLot---");
    ...
    {
        //$System.out.println("---entered testFillingLot---");
    ...
    {
        //$System.out.println("---entered testRefillingLot---");
    ...
    {
        //$System.out.println("---entered test0TimeEntryExit---");
    ...
    {
        //$System.out.println("---entered testFillingTo80Percent---");
    ...
    {
        //$System.out.println("---entered testDistrict---");
    ...
    {
        //$System.out.println("---entered testHeavyUsage---");
